...
export const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    description: 'Save up to 35% on everyday devices selected for work, play, and everything between.',
  ...
  },
  {
    ...
    description: 'Discover standout accessories and wardrobe staples from emerging marketplace sellers.',
  ...
  },
  {
    ...
    description: 'Refresh your space with useful, beautifully considered finds from trusted sellers.',
